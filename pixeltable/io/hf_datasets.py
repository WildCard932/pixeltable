...
def huggingface_schema_to_pxt_schema(
    hf_schema: datasets.Features, schema_overrides: Optional[dict[str, pxt.ColumnType]]
...
def import_huggingface_dataset(
    ...
    **kwargs: Any,
    ...
    from .globals import _normalize_schema_names
    ...
    hf_schema = huggingface_schema_to_pxt_schema(hf_schema_source, schema_overrides)
    ...
    schema, _ = _normalize_schema_names(hf_schema, True)
    pxt_pk = primary_key
