...
from .globals import _find_or_create_table, _normalize_schema_names
...
def import_pandas(
    ...
    *,
    ...
    schema, col_mapping = _normalize_schema_names(pd_schema, False)
...
def __df_row_to_pxt_row(
    row: tuple[Any, ...], schema: dict[str, pxt.ColumnType], col_mapping: dict[str, str]
) -> dict[str, Any]:
    ...
    for val, (col_name, pxt_type) in zip(row[1:], schema.items()):
        ...
        pxt_row[col_mapping[col_name]] = val
    return pxt_row
